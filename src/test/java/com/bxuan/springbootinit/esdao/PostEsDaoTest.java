package com.bxuan.springbootinit.esdao;
...
public class PostEsDaoTest {
    ...
    void testAdd() {
        ...
        postEsDTO.setId(1L);
        postEsDTO.setTitle("bxuan是狗吗，不是");
        postEsDTO.setContent("bxuan虽然不是狗，但是他真的找不到工作了");
    ...
    void testFindByTitle(){
        List<PostEsDTO> postEsDTOS = postEsDao.findByTitle("bxuan鱼狗");
